      ...
      <div className="container">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
            <div className="lg:col-span-2" data-aos="fade-right">
              <img src="https://i.imgur.com/exemplo2.png" alt="Segunda Oferta" className="rounded-xl shadow-lg w-full object-cover" />
            </div>
            <div className="lg:col-span-3" data-aos="fade-left">
              <div className="bg-white text-dark-800 p-8 rounded-xl shadow-lg">
                <h3 className="text-2xl font-bold mb-6 text-center">OFERTA ESPECIAL - Kit Luminárias Premium</h3>
                <div className="flex justify-center mb-4">
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 text-accent-500 fill-accent-500" />
                ...
                <div className="text-center mb-6">
                  <span className="text-sm line-through text-slate-500 block mb-1">De R$ 489,90</span>
                  <div className="flex items-center justify-center gap-3">
                    <span className="text-4xl font-bold text-accent-600">R$ 239,90</span>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <Check className="w-5 h-5 text-success-500" />
                    <span>Garantia estendida de 24 meses</span>
                  </div>
                </div>
                <div className="mb-8">
                  <div className="relative w-full h-3 bg-slate-200 rounded-full overflow-hidden mb-2">
                ...
                <a href="https://seucheckout.com.br/oferta2" className="w-full py-6 px-8 bg-accent-600 hover:bg-accent-700 text-white rounded-2xl font-bold text-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 mb-6">
                  <ShoppingCart className="w-7 h-7" />
